...
class _RegisterState extends State<Register> {
   ...
   static Future<bool> checkExist(String email) async {
    bool exists = false;
    try {
      await FirebaseFirestore.instance.collection("users").doc(email).get().then((doc) {
        if (doc.exists)
          exists = true;
        else
          exists = false;
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                            ...
                            decoration: InputDecoration(
                                ...
                                (icon: Icon(_obscureText2?FlutterIcons.eye_fea:FlutterIcons.eye_off_fea),
                                onPressed: (){
                                  setState(() {
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                            ...
                            validator: (value){
                                   ...
                                   return (value!=passcontroller.text)? "Password and Confirm Password doesn't match" : null;
                                },
                      ...
                      child: Listener(
                            ...
                            onPointerUp: (item) async{
                              ...
                              if (_formKey.currentState.validate()) {
                                ...
                                if(await checkExist(emailcontroller.text))
                                {
                                 try {
                                 ...
                                 if (e.code == 'weak-password') {
                                  ...
                                  setState(() {
                                     _loading=false;
                                     _displayusererror=true;
                                     errmsg='You have already registered. Please goto Login.';
                                   });
                                }
                                } catch (e) {
                                 setState(() {
                              ...
                              else
                              {
                                print("lanja");
                                  ...
                                  _loading=false;
                                  _displayusererror=true;
                                  errmsg="Please Register with the email you provided at clg";
