...
List<Companies>s=[Companies("Infosys",["Candidate Should be Human","Canditate should eat both veg and non-veg"],"30-12-2021",true),
Companies("Wipro",["Candidate Should be Alien","Canditate must donate an UFO to company"],"30-12-2022",true),
Companies("Cognizant",["Candidate Should be from China","Canditate should eat Aliens also"],"31-12-2023",true),
Companies("Yahoo",["Candidate Should be yoho","Canditate must wear goggles"],"10-22-2021",false),
];
