              ...
              children: [
                ...
                Wrap(
                  ...
                  children: _placements
                      .map((package) => Padding(
                            padding:
                                const EdgeInsets.fromLTRB(4.0, 0.0, 8.0, 10.0),
                            child: Container(
                              width: 80,
                              child: Row(children: [
                                Container(
                  ...
                  child: Padding(
                    ...
                    child: Container(
                      ...
                      children: [
                        SizedBox(height: 12),
                        Text(
                          "Total number of placements: " + "172",
                          style: TextStyle(
                            fontSize: 18,
                          ),
                        ),
                        SizedBox(height: 12),
                        Text(
                          "Total Number Of Students Participated: " + "120",
                          style: TextStyle(
                            fontSize: 18,
                          ),
                        ),
                        SizedBox(height: 12),
                        Text(
                          "Percentage of Students Placed: " + "64%",
                          style: TextStyle(
                            fontSize: 18,
                          ),
                        ),
                        SizedBox(height: 12),
                        Text(
                          "Heighest Package Offered: " + "12 LPA",
                          style: TextStyle(
                            fontSize: 18,
                          ),
                        ),
                        SizedBox(height: 12),
                        Text(
                          "Highest Package offered Company: " +
                              "Name Marchipoyya",
                          style: TextStyle(
                            fontSize: 18,
                          ),
                        ...
                        SizedBox(height: 12),
                        Text(
                          "Student who got Highest Package : " + "JP, VB",
                          style: TextStyle(
                            fontSize: 18,
                          ),
                        ),
                        ...
                        SizedBox(height: 12),
                        Text(
                          "Company Offering Higher Placements: " + "Telidhu",
                          style: TextStyle(
                            fontSize: 18,
                          ),
                        ),
