...
class _CompaniesVisitedState extends State<CompaniesVisited> {
  List<BarChartGroupData> _bargroupdata = c
      .map(
                ...
                itemBuilder: (BuildContext context) {
                  return [
                    PopupMenuItem<String>(
                      value: "pkg",
                      child: Text("Package Offered"),
                    ),
                    PopupMenuItem<String>(
                      value: "rec",
                      child: Text("Total Recruitments"),
                    )
                  ];
                })
          ],
                    ...
                    children: c
                        .map(
                          (comp) => Container(
                            ...
                            child: Padding(
                              padding:
                                  const EdgeInsets.fromLTRB(10, 22, 10, 19),
                              child: Row(
                                children: [
                                  Container(
                                    width: 60,
